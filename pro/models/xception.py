...
# Import the Xception library as shown below and add xception
...
plt.legend()
plt.show()
plt.savefig('LossVal_loss_xception_599')
...
plt.legend()
plt.show()
plt.savefig('AccVal_accuracy_xception_599')
...
model.save('model_xception_599.h5')

model_json = model.to_json()
with open('model_adam_xception_2020_599 .json', 'w') as json_file:
