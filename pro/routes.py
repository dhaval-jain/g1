...
def upload():
    ...
    for upload in request.files.getlist("file"):
        ...
        new_model = load_model('C:/Users/meow/PycharmProjects/FRUIT/model_main_model_vggbobo.h5')
        new_model.summary()
        test_image = image.load_img('C:/Users/meow/PycharmProjects/FRUIT/images//' + filename, target_size=(224, 224))
    ...
    if prediction is classes[0]:
         print("Covid Positive CT image")
    else:
        print("Normal Lungs")
